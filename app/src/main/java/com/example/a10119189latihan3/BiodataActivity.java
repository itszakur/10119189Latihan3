package com.example.a10119189latihan3;
...
public class BiodataActivity extends AppCompatActivity {
    ////22 April 2022, 10119189, Reza Kurnia, IF5
    ...
    void selanjutnya() {
        ...
        if (isStringEmpty(nameBiodata)) {
            ...
            Intent intent = new Intent(this, com.example.a10119189latihan3.DoneActivity.class);
